...
public class Table extends javax.swing.JFrame {
    ...
    void display(){
        ...
        try {
          ...
          ResultSet info = stmt.executeQuery("select * from javacrud");
          DefaultTableModel model = (DefaultTableModel) table.getModel();
          while (info.next()) {
              count = 1;
              model.addRow(new Object[]{info.getInt("pnStudent_id"), info.getString("firstName"), info.getString("lastName"), info.getString("address"), info.getString("gender")});
          }
          if (count == 0) {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "Address", "Gender"
            }
        ));
        ...
        jLabel1.setText("PN STUDENT RECORD BATCH 2021");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       try {
           ...
           String query = "TRUNCATE TABLE `javacrud`";
